...
for file1 in os.listdir("."):
    print("1 " + file1)
    if os.path.isdir(os.path.join(os.path.abspath("."), file1)):
        for file2 in os.listdir(os.path.join(os.path.abspath("."), file1)):
            print("2\t" + file2)
            if file2.endswith(".py"):
                print("Loading: " + file2)
                client.load_extension(f"{file1}.{file2[:-3]}")
            elif os.path.isdir(os.path.join(os.path.join(os.path.abspath("."), file1), file2)):
                for file3 in os.listdir(os.path.join(os.path.join(os.path.abspath("."), file1), file2)):
